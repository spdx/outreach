...
An example should be used throughout the guide. It is suggested to use the Acme example from the SPDX 3.0 specification as a base with any additional classes, profiles, or properties added as required for that community.
